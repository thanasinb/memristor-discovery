 ...
 * @author timmolter
 */
public class ProgramPreferences extends ExperimentPreferences {
  ...
  public static final String TARGET_R_INIT_KEY = PREFIX + "TARGET_R_INIT_KEY";
  public static final int TARGET_R_INIT_DEFAULT_VALUE = 50_000;
  ...
  public static final String REVERSE_AMPLITUDE_INIT_FLOAT_KEY = PREFIX + "REVERSE_AMPLITUDE_INIT_FLOAT_KEY";
  public static final float REVERSE_AMPLITUDE_INIT_FLOAT_DEFAULT_VALUE = -1f;
  public static final String REVERSE_PULSE_WIDTH_INIT_KEY = PREFIX + "REVERSE_PERIOD_INIT_KEY";
  public static final int REVERSE_PULSE_WIDTH_INIT_DEFAULT_VALUE = 50_000;
  public static final String REVERSE_NUM_PULSES_INIT_KEY = PREFIX + "REVERSE_NUM_PULSES_INIT_KEY";
  public static final int REVERSE_NUM_PULSES_INIT_DEFAULT_VALUE = 1;
  public static final String REVERSE_PULSE_DUTY_CYCLE_KEY = PREFIX + "REVERSE_PULSE_DUTY_CYCLE_KEY";
  public static final float REVERSE_PULSE_DUTY_CYCLE_DEFAULT_VALUE = .5f;

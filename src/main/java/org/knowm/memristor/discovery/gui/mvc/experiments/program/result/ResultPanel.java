...
public class ResultPanel extends JPanel {
  ...
  XYChart reverseWaveformChart;
  XChartPanel<XYChart> reverseWaveformChartPanel;
  ...
  public ResultPanel() {
    ...
    reverseWaveformChart =
            new XYChartBuilder()
                    ...
                    .xAxisTitle("Time [µs]")
                    .build();
    reverseWaveformChart.getStyler().setLegendVisible(false);
    series = reverseWaveformChart.addSeries("reverse_waveform", new double[] {0}, new double[] {0});
    series.setMarker(
            SeriesMarkers
                    .NONE); // waveformChart.getStyler().setDefaultSeriesRenderStyle(XYSeriesRenderStyle.Line);
    reverseWaveformChartPanel = new XChartPanel<>(reverseWaveformChart);
    ...
    iTChart =
        new XYChartBuilder()
            ...
            .title("I-T")
            .height(300)
            .yAxisTitle("Current [" + ProgramPreferences.CURRENT_UNIT.getLabel() + "]")
            .xAxisTitle("Time [µs]")
            .build();
    ...
    gChart =
        new XYChartBuilder()
            ...
            .yAxisTitle("Conductance [" + ProgramPreferences.CONDUCTANCE_UNIT.getLabel() + "]")
            .build();
  ...
  public void switch2WaveformChart() {
    ...
    if (!waveformChartPanel.isShowing()) {
      ...
      chartsPanel.add(waveformChartPanel, BorderLayout.NORTH);
      chartsPanel.add(reverseWaveformChartPanel, BorderLayout.CENTER);
  ...
  public XYChart getReverseWaveformChart() {

    return reverseWaveformChart;
  }

  public XChartPanel<XYChart> getReverseWaveformChartPanel() {

    return reverseWaveformChartPanel;
  }

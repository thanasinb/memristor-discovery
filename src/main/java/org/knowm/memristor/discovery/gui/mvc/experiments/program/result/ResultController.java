...
public class ResultController {
  ...
  public void updateReverseWaveformChart(
          double[] reverseTimeData, double[] reverseWaveformAmplitudeData, double reverseAmplitude, int reversePulseWidth) {

    resultPanel.getReverseWaveformChart().setTitle(getReverseWaveformChartTitle(reverseAmplitude, reversePulseWidth));
    resultPanel
            .getReverseWaveformChart()
            .updateXYSeries("reverse_waveform", reverseTimeData, reverseWaveformAmplitudeData, null);
    resultPanel.getReverseWaveformChartPanel().revalidate();
    resultPanel.getReverseWaveformChartPanel().repaint();
  }
  ...
  private String getReverseWaveformChartTitle(double reverseAmplitude, int reversePulseWidth) {

    return "Reverse Waveform: " + getWaveform(reverseAmplitude, reversePulseWidth);
  }
